...
const translations = {
  es: {
    ...
    "home.hero.description.short":
      "Soy un Desarrollador de Datos y Analítica (llamado 'Analytics Engineer' en la industria tech) con un enfoque de pensamiento sistémico (systems-thinking). Me especializo en ir más allá de los simples dashboards: diseño y construyo los motores de datos automatizados que transforman el ruido operativo en inteligencia estratégica. Gestiono el ciclo de vida completo de los datos, desde...",
  ...
  en: {
    ...
    "home.hero.description.short":
      "I am a Data & Analytics Engineer with a systems-thinking approach. I specialize in going beyond simple dashboards: I design and build the automated data engines that transform operational noise into strategic intelligence. I manage the entire data lifecycle, from architecture and ETL...",
    "home.hero.description.full":
      "I am a Data & Analytics Engineer with a systems-thinking approach. I specialize in going beyond simple dashboards: I design and build the automated data engines that transform operational noise into strategic intelligence. I manage the entire data lifecycle, from architecture and ETL pipelines to the visualizations that leaders need to make critical decisions. My work is about converting operational chaos into strategic clarity. I have experience building end-to-end BI solutions, such as my project analyzing wildfire trends with Python and Power BI, and processing large datasets with SQL or Google BigQuery for market intelligence dashboards. I am looking to join a team where I can design and build scalable data solutions that have a direct impact on the business. If your organization needs a bridge between data engineering and business strategy, I would love to connect.",
